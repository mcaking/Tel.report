...
to(
    f"\033[31;m TOOL >> \033[1;36mTELEGRAM REPORT SCRIPT\n\033[1;31m DEVELOPER >>\033[1;33m Cyber Sakib \n\033[31;m JOIN >> \033[1;36m https://t.me/bd_muslim_Cyber_Army \n")
def R(m,email,num):
...
while True:
 ...
 R(m,email,num)
#BY Abdullha_404: @Abdullha_404  oN: @Abdullha_404 🔥❄. 
